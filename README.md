...
- [ ] Explain benefit(s) using `client-side routing`?
  > Answer: faster because less data is being processed and runs smoother and can add animations easier
- [ ] What does AJAX stand for?
  > Answer: Asynchronous JavaScript and XML
- [ ] What are `controlled components` in React?
  > Answer: the single source of truth!! a component that renders a form also controls what happens in that form
