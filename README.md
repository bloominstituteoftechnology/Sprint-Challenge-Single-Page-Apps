...
> Answer:
The benefits are that less data is processed, routing between views is generally faster. There is a smoother transition and animations between views are easier to implement.
## Project Set Up
