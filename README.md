...
> Answer: Client side routing is good because since there's less data being processed, the load time is much fast for the browser. It makes transitions and animations easier to implement as well.
