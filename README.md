...
> Answer: You don't have to wait for the server to reply. This speeds up the user experience and lets the client render navigation and request information more efficiently.
