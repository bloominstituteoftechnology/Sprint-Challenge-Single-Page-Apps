...
> Answer: Client side routing maps urls within the browser rather than through a server. Client side allows us to make applications in a single page, rather than multiple pages. This can allow for quicker rendering and better performance.
