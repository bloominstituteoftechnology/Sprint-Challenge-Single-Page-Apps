...
> Answer: Its less server use on the host and lessens the requests to the server to produce a quicker UI experience 
- [ ] What does AJAX stand for?
> Answer: Asynchronous javascript and xml 
- [ ] What are `controlled components` in React?
> Answer: Component actions are handled through a JSX attribute such as onChange 
- [ ] Name three tools/libraries for making AJAX requests.
> Answer: axios, request, fetch
