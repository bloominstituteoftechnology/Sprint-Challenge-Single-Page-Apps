...
> Answer: It provides the user with faster interactions with the website after the initial load
...
> Answer: a JavaScript function that handles the submission of the form and has access to the data that the user entered into the form.
