...
> Answer: Using client side routing you prevent the page from reloading completely and instead just some things about the page change. There is also less data being transferred so it is faster than regular routing 
- [ ] What does AJAX stand for?
> Answer: Asynchrounous Javascript and XML
- [ ] What are `controlled components` in React?
> Answer:Controlled components are components that we can controll that allow us to interact with forms
